...
<div class="container-fluid background-section-img" style="background-image:url('<?php bloginfo( 'template_directory' ) ?>/assets/img/iconic-background.483b535fc8d82d0bac10.png');">
	<div class="container">
	<div class="row">
...
<div class="container-fluid offer-include">
	<div class="container">
	<div class="row">
		<div class="col-md-4">
		<img src="<?php bloginfo( 'template_directory' ) ?>/assets/img/logo.png" class="offer-logo"/>
		<h4 class="offer-title">
			Offer Includes
		</h4>
		<h1 class="offer-heading"> To provide <span class="red-text">Your Business</span> a Stunning Individuality, we go above and  <span class="red-text">go above</span> beyond!</h1>
		<span class="call-for-qoutation-offer">Call for a Quotation</span><br>
		<a href="tel:(281) 624-0001"><span class="number">(281) 624-0001</span></a>
		</div>
		<div class="col-md-8">
			<div class="container">
...
molestiae quas vel sint commodi quas vel sint commodi
						...
						<p class="offer-para">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,
molestiae quas vel sint commodi quas vel sint commodi						</p>
					</div>
				</div>
			</div>
		</div>
